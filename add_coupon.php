...
<div id="content-header">
  <div id="breadcrumb"> <a href="dashboard.php" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a> <a href="manage_shop" class="tip-bottom">Manage Coupon</a> <a href="javascript:void(0);" class="current">Add Coupon</a> </div>
  <h1>Add Shop Coupon</h1>
</div>
        ...
        <div class="widget-content nopadding">
         <form class="form-horizontal" method="post" action="" autocomplete="off">
			...
			<div class="alert alert-error1" style="display:none;">
                 <button class="close" data-dismiss="alert">×</button>
                  <strong>Warning ! </strong>Category Name already exit. Please try to new. 
			</div>
			<!--Message-Part-End-->
			<div class="test"></div>
			...
			<div class="control-group">
              ...
              <div class="controls">
                <div  data-date="02-12-2012" class="input-append date datepicker">
				  ...
				  <label id="error_date" class="error">Please Enter Coupon Ending Date Is Lower Than Coupon Starting Date.</label>
                  </div>
              </div>
            </div>
			...
			<div class="control-group">
              ...
              <div class="controls">
                <input type="text" placeholder="Coupon Name" class="span6" id="name"/>
		    ...
		    <div class="control-group">
              ...
              <div class="controls">
                <input type="text" placeholder="Coupon Price" class="span6" id="price"/>
             ...
             <div class="control-group">
              ...
              <div class="controls">
                <input type="text" placeholder="Coupon Price" class="span6" id="code"/>
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <textarea id="desc" placeholder="Coupon Description" class="span6" ></textarea>
...
$(document).ready(function() { 
	        $(document).delegate(".add_coupon","click",function(){
				   //alert();return false;
					...
					$.ajax({
					url: 'ajax/add_coupon.php', // point to server-side PHP script 
